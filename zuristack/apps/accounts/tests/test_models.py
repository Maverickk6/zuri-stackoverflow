...
class CustomUserManagerTests(TestCase):
    ...
    def test_create_superuser(self):
        ...
        admin_user = User.objects.create_superuser(
            email='superuser@email.com', password='foo')
...
class CustomUserModelTests(TestCase):
    def test_user_slug_is_unique(self):
        ...
        user2 = User.objects.create_user(
            email='user2@email.com', password='foo')
    ...
    def test_user_slug_is_not_overwritten(self):
        User = get_user_model()
        user = User.objects.create_user(email='user@email.com', password='foo', slug='wierd-slug')
        self.assertEqual(user.slug, 'wierd-slug')
